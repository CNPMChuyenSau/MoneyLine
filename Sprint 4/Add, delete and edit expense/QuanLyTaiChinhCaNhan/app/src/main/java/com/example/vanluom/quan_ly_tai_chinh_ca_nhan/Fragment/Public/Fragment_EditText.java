...
public class Fragment_EditText extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AnhXa();
        EditTextDescription.setText(String.valueOf(txt.getText().toString() + " "));
    ...
    private void AnhXa() {
        ...
        layerAddChi = (LinearLayout) view.findViewById(R.id.linear_layout_them_giao_dich);
